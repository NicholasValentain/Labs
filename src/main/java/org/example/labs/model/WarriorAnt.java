...
public class WarriorAnt extends Ant {
    ...
    private static String path = "C:/Users/User/Downloads/Lab5_FINALL/Lab5_S_V/Lab5_S_V/Lab5/Labs/Labs/src/main/resources/org/example/labs/AntGIF/ant2.gif";
    ...
    public WarriorAnt(int _x, int _y, long birthTime, long lifeTime) throws FileNotFoundException {
        super(_x, _y, image, path, "war", birthTime, lifeTime);
